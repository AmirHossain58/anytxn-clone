  ...
  return (
    <>
      <section
        ...
        className={`relative bg-[radial-gradient(24.45%_88.58%_at_23.57%_2%,#00e9ea_0%,#1f80f0_52.08%,#005bc4_100%)]   h-[60vh] lg:h-[400px] w-full text-white bg-clip-cta overflow-hidden bg-no-repeat bg-cover md:z-20 z-0 ${
        ...
        >
          <g id="cta-background-patterns">
            <g
              id="dark-patterns"
              style={{
                transform: "translate3d(-0.331501%, 1.16624%, 0px)",
                 // @ts-ignore
...
>
            ...
            <g
              id="light-patterns"
              style={{
                transform: "translate3d(0.1989%, -0.699742%, 0px)",
                // @ts-ignore
                "--motion-translateX": "0px",
                "--motion-translateY": "0px",
                opacity: 1,
      ...
      {/* <section className="relative bg-blue-600  max-w-[1138px] mx-auto  h-[60vh] lg:h-[530px] w-full text-white bg-clip-cta overflow-hidden bg-[url('https://anytxn.com//backgrounds/ctaMobileWaveLines.svg')] bg-no-repeat bg-cover md:z-20 z-0">
