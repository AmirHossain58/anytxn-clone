...
export default function HeroSection() {
  ...
  const handleMouseMove = (e: React.MouseEvent<SVGSVGElement, MouseEvent>) => {
    ...
    setPosition({ x: (clientX - window.innerWidth / 2) / 40, y: (clientY - window.innerHeight / 2) / 40 });
  };
  ...
  return (
    <>
      ...
      style={{
       ...
       className=" md:min-h-[70vh] z-40  relative overflow-hidden">
        <NavbarHome />
        ...
        {/* LG device svg */}
        <motion.svg
    initial={{ opacity: 0, x: -100 }} // Start from the right (100px)
    ...
    onMouseMove={handleMouseMove}
      className="hidden z-20 lg:block duration-200 transition-all absolute h-full w-full object-cover inset-0"
      width="1920"
      height="929"
    ...
    >
      <g id="hero-background-desktop">
        <g
          id="background"
          style={{
            transform: "translate3d(-0.0241379%, 1.11307%, 0px)",
            // @ts-ignore
        ...
        <g
          id="foreground"
          style={{
            transform: "translate3d(0.0144828%, -0.667845%, 0px)",
            // @ts-ignore
            "--motion-translateX": "0px",
            "--motion-translateY": "0px",
            opacity: 1,
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="6"
            result="effect1_fore ```jsx
      GaussianBlur_132_3263"
          />
        </filter>
        <filter
        ...
        >
          <g id="hero-background-mobile">
            <g id="dark" className="transition-transform duration-500 ease-out">
              <g id="Group" className="mix-blend-multiply">
                <path
                  id="Vector"
              ...
              <g id="Group_2" className="mix-blend-multiply">
                <path
                  id="Vector_2"
              ...
              <g id="Group_3" className="mix-blend-multiply">
                <path
                  id="Vector_3"
          ...
          <div className="relative z-10 w-full h-full flex items-center justify-center">
            <div className="h-fit lg:flex-[65] xl:flex-[75]">
              <header className=" space-y-4 lg:space-y-2 mb-8">
                <h1 className="lg:max-w-lg lg:whitespace-pre-line text-white font-bold text-4xl lg:text-6xl">
                  Embrace the  future of finance
                </h1>
                <h5 className="text-white max-w-[37rem] text-lg lg:text-2xl font-Montserrat ">
              ...
              <div className="flex flex-col lg:flex-row lg:space-x-4 space-y-4 lg:space-y-0 w-full max-w-xl">
                <a
                  href="/en/contact-us"
                  className="py-4 px-10 rounded shadow-md text-white flex items-center justify-center space-x-2 font-semibold gap-2 hover:mr hover:gap-3  bg-[#fe8b53] hover:bg-orange-500 transition-all duration-300"
                >
            ...
            <div className="hidden lg:flex lg:flex-[35] xl:flex-[25]"></div>
          </div>
        </div>
        {/*bg image  */}
        <div className="hidden  lg:block absolute top-0  xl:left-[30%] xl:w-[65%] left-1/2 lg:w-[56%] h-full pointer-events-none animate-">
      <figure className="ml-20 h-[110%] w-[110%] ">
        <motion.img
